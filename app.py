...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:kjGxNrdhdKkdKwoLfzhOVCEJcDwhDZuY@postgres.railway.internal:5432/railway'  # Railway cung cấp biến này
